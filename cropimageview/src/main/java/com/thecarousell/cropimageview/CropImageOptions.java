...
public class CropImageOptions implements Parcelable {
     ...
     */
    public CropImage.CropShape cropShape;

    /**
     * An edge of the crop window will snap to the corresponding edge of a specified bounding box
     * when the crop
     * window edge is less than or equal to this distance (in pixels) away from the bounding box
     * edge. (in pixels)
     */
     ...
     */
    public CropImage.Guidelines guidelines;

    /**
     * The initial scale type of the image in the crop image view
     */
    public CropImage.ScaleType scaleType;
    ...
    public CropImageOptions() {
        ...
        cropShape = CropImage.CropShape.RECTANGLE;
        ...
        guidelines = CropImage.Guidelines.ON_TOUCH;
        scaleType = CropImage.ScaleType.FIT_CENTER;
    ...
    protected CropImageOptions(Parcel in) {
        cropShape = CropImage.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = CropImage.Guidelines.values()[in.readInt()];
        scaleType = CropImage.ScaleType.values()[in.readInt()];
    ...
    public void validate() {
        ...
        if (maxCropResultHeight < minCropResultHeight) {
            throw new IllegalArgumentException(
                    "Cannot set max crop result height to smaller value than min crop result "
                            + "height");
        }
